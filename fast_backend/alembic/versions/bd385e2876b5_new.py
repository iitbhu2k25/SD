...
Revision ID: bd385e2876b5
Revises: 
Create Date: 2026-04-01 08:45:29.071995
...
def upgrade() -> None:
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('modified_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['parent_id'], ['user_storage.id'], ),
    sa.PrimaryKeyConstraint('id'),
    ...
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('modified_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['file_id'], ['user_storage.file_id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('file_id')
    )
    ...
    sa.Column('crs_unit', sa.String(), nullable=False),
    sa.Column('file_size', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('attribute_schema', postgresql.JSON(astext_type=sa.Text()), nullable=True),
    sa.Column('id', sa.Integer(), autoincrement=True, nullable=False),
    sa.Column('created_at', sa.DateTime(), nullable=False),
    sa.Column('modified_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['file_id'], ['user_storage.file_id'], ),
