...
catchment_zip = os.path.join(BASE_DIR_NEW,  'shape_stp', 'Drain_stp', 'Catchment', 'Catchment.zip')
stretch_zip = os.path.join(BASE_DIR_NEW,  'shape_stp', 'Drain_stp', 'Stretches', 'Stretches.zip')
drain_zip = os.path.join(BASE_DIR_NEW,  'shape_stp', 'Drain_stp', 'Drains', 'Drain.zip')
...
try:
    ...
    upload_shapefile("dss_vector","vector_store",state_zip,"STP_State")
    upload_shapefile("dss_vector","vector_store",district_zip,"STP_district")
    upload_shapefile("dss_vector","vector_store",subdistrict_zip,"STP_subdistrict")
    upload_shapefile("dss_vector","vector_store",river_zip,"Rivers")
    upload_shapefile("dss_vector","vector_store",boundry_zip,"Boundary")
