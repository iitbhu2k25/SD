...
type YearContextType = {
  ...
  focusedWellPoint: WQIInterface | null
  setFocusedWellPoint: (point: WQIInterface | null) => void
};
...
export const YearProvider = ({ children }: { children: React.ReactNode }) => {
  ...
  const [focusedWellPoint, setFocusedWellPoint] = useState<WQIInterface | null>(null);
  ...
  return (
    <YearContext.Provider
      value={{
        ...
        focusedWellPoint, setFocusedWellPoint,
      }}
    >
      {children}
    </YearContext.Provider>
