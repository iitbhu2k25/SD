...
const updateIndustrialConsumption = (industry: string, subtype: string, newConsumption: number) => {
  ...
  const fetchCropsForSeason = async (season: string) => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_FAST_URL}/gwa/crops`, {
        method: 'POST',
        headers: {
  ...
  const computeDomesticDemand = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_FAST_URL}/gwa/forecast-population`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const computeAgriculturalDemand = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_FAST_URL}/gwa/agricultural`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
  ...
  const computeIndustrialDemand = async () => {
    try {
      ...
      const response = await fetch(`${process.env.NEXT_PUBLIC_FAST_URL}/gwa/industrial`, {
        method: 'POST',
        headers: {
          'Content-Type': 'application/json',
        },
