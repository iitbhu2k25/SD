...
// This shows an error message if the admin page fails to load.
// The button lets the user try loading the page again.
  ...
  return (
    <div className="w-full h-full flex items-center justify-center bg-red-50 p-6">
      <div className="max-w-md w-full border border-red-200 bg-white rounded-lg p-4">
        <h2 className="text-sm font-semibold text-red-700 mb-2">Admin view failed to load</h2>
