      ...
      <div className={isMinimized ? "p-2.5 sm:p-3" : "p-3 sm:p-4"}>
        <div className="flex flex-row items-center justify-between gap-2">
          ...
          <button
            ...
            title={isMinimized ? "Expand priority insights" : "Minimize priority insights"}
            aria-label={isMinimized ? "Expand priority insights" : "Minimize priority insights"}
          >
          ...
          >
            ...
            <div className="mt-3 flex items-center gap-3">
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  Urgent STP intervention needed
                </div>
              </div>
            </div>
          </div>
