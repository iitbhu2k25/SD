...
export default function PriorityRiskSummary({
  ...
  return (
    <section
      className={`mt-3 rounded-3xl border shadow-[0_16px_34px_rgba(0,0,0,0.12)] transition-all sm:mt-4 ${
        isDark
      ...
      <div className={isMinimized ? "p-2.5 sm:p-3" : "p-3 sm:p-4"}>
        <div className="flex flex-row items-center justify-between gap-2">
          ...
          <CollapseToggle
            ...
            expandLabel="Expand STP suitability insights"
            collapseLabel="Minimize STP suitability insights"
            isDark={isDark}
          />
        </div>
