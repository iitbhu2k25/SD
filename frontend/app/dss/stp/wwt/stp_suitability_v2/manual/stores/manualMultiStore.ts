...
import type { MultiAreaSingleResult, MultiFindPathSingleResult, MultiPolygonEntry } from "../../services/stpSuitabilityTypes";
...
export interface MultiPolygonResult {
  ...
  clusterDistances: import("../../services/stpSuitabilityTypes").ClusterInfo[] | null;
}
