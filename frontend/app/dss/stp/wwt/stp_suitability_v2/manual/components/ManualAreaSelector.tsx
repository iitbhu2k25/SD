...
import { confirmManualAreaSelection, fetchManualSuitabilityDisplayRaster, fetchDrainsInBbox, checkManualConstraints, confirmMultiAreaSelection, previewPolygon } from "../../services/stpSuitabilityApi";
import type { ClipRasters, MultiPolygonEntry } from "../../services/stpSuitabilityTypes";
...
function DrainSelector() {
  ...
  return (
    <div className="mt-3 rounded-xl border border-violet-200 bg-violet-50 p-3">
      <p className="mb-1.5 text-xs font-semibold text-violet-700">Available Drains</p>
...
function MultiDrainSelector() {
  ...
  return (
    <div className="mt-3 rounded-xl border border-violet-200 bg-violet-50 p-3">
      <p className="mb-1.5 text-xs font-semibold text-violet-700">
