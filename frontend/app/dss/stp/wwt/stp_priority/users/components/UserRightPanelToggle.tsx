...
// This file shows the floating arrow button for opening and closing the user right panel.
interface UserRightPanelToggleProps {
  isOpen: boolean;
  openOffsetClass: string;
  onToggle: () => void;
}

export default function UserRightPanelToggle({
  isOpen,
  openOffsetClass,
  onToggle,
}: UserRightPanelToggleProps) {
  return (
    <button
      onClick={onToggle}
