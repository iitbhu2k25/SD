    ...
    <div className="bg-gray-50 flex flex-col">
      <WholeLoading
        ...
        title={
          ...
          reportLoading ? "Generating STP Suitability Report"   :
                          "Loading Resources"
        }
        message={
          stpOperation  ? "Analyzing suitability and generating results..."       :
          reportLoading ? "Please wait while your report is being generated..."   :
