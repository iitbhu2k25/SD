                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          STP Suitability module is intended to identify the suitable locations for the STP construction in the sewage high priority zones.
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-green-500 hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          The suitable location for the STP is being identified, combining several GIS-based conditioning (groundwater, land-use, hydrological layer, soil etc.) and constraint layers (ASI, Road, railways, Flood plain etc.) through multi-criteria decision making model.
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-purple-500 hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          This model is also also enable to provide the pin-point location of the STP of the desired capacity of the selected technology (e.g. MBR, SBR, ASP etc.)
                  ...
                  <div className="bg-white rounded-lg p-4 shadow-sm border-l-4 border-purple-500 hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        <p className="text-sm text-gray-600 leading-relaxed">
                          Final output related to the sewage site suitability could be generated in the pdf format.
