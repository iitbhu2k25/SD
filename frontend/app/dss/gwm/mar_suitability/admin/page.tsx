...
const MainContent = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="px-4 py-8 h-[calc(100vh-4rem)] overflow-hidden">
        {/* Two independent scroll areas */}
        <div className="grid grid-cols-1 lg:grid-cols-8 gap-6 h-full">
          {/* LEFT SIDE - Scrollable */}
          <div className="lg:col-span-4 h-full overflow-y-auto pr-2 space-y-4">
          ...
          <div className="lg:col-span-4 h-full overflow-y-auto space-y-4">
            <section className="bg-white rounded-xl shadow-md overflow-hidden">
              <div className="w-full h-[620px] p-2">
                <MapView />
              </div>
            </section>
