  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <WholeLoading
        ...
        title={stpOperation ? "Analyzing suitability" : "Loading Resources"}
        message={
          stpOperation
      ...
      {/* Outer grid for left and right sections */}
      <div className="grid grid-cols-1 lg:grid-cols-8 gap-6 h-screen px-4 py-6">
        {/* Left Section - Independent scroll */}
        <div className="lg:col-span-4 overflow-y-auto h-full pr-2 space-y-4">
                    ...
                    >
                      ...
                      >
                        <path
                          ...
                          strokeLinejoin="round"
                          strokeWidth={2}
                          d="M4 16v2a2 2 0 002 2h12a2
                          2 0 002-2v-2M7 10l5 5m0 0l5-5m-5
                          5V4"
                        />
                      </svg>
                      Download CSV
        ...
        <div className="lg:col-span-4 overflow-y-auto h-full pl-2 space-y-4">
          <section className="bg-white rounded-xl shadow-md overflow-hidden">
              ...
              {activeTab === "condition" &&
                (selectedCondition.length === 0 ? (
                  <div className="p-8 text-center text-gray-500">
                    No condition categories selected. Please select at least one.
                  </div>
                ) : (
                  <div className="p-4">
