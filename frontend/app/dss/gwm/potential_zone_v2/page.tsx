...
import { gwzPotentialPanelSettings } from "./config/panels.config";
...
export default function GwzPotentialV2Page() {
  const panelSettings = gwzPotentialPanelSettings;
  ...
  const pageLayout = (
    <>
      <WholeLoading
        ...
        message={
          isActiveStpOperation
            ? "Analyzing groundwater potential zones and generating results..."
            : isActiveReportLoading
      ...
      <ModuleInfoModal
        ...
        title="Groundwater Potential Zone System"
        imageSrc="/Images/modules/image_25.png"
        imageAlt="Groundwater Potential Zone Information"
        points={[
          "Groundwater Potential Zone module identifies areas with varying groundwater recharge potential.",
          "Several GIS-based layers related to geology, geomorphology, soil, slope, drainage density, and land use are used to delineate groundwater potential zones.",
          "Final output related to the groundwater potential can be generated in PDF format.",
        ]}
        learnMoreHref="/dss/home/home_grid/home_card/basic_module"
        learnMoreLabel="Learn more about Groundwater Potential Zone"
      />
    </>
  );
