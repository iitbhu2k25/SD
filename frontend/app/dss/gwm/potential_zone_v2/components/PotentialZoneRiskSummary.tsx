...
import { PriorityRiskCounts } from "../utils/riskFactorSummary";

interface PotentialZoneRiskSummaryProps {
...
export default function PotentialZoneRiskSummary({
  counts,
  isDark = false,
}: PotentialZoneRiskSummaryProps) {
  ...
  const highPriorityCount = safeCounts.high + safeCounts.veryHigh;
  const highPriorityPercent = total > 0 ? (highPriorityCount / total) * 100 : 0;
  ...
  const ringOffset =
    ringCircumference * (1 - Math.min(100, Math.max(0, highPriorityPercent)) / 100);
      ...
      <div className={isMinimized ? "p-2.5 sm:p-3" : "p-3 sm:p-4"}>
        <div className="flex flex-row items-center justify-between gap-2">
          ...
          <button
            ...
            title={isMinimized ? "Expand potential zone insights" : "Minimize potential zone insights"}
            aria-label={isMinimized ? "Expand potential zone insights" : "Minimize potential zone insights"}
          >
        ...
        {!isMinimized && (
            ...
            <div className="mt-3 flex items-center gap-3">
              <div className="relative h-[108px] w-[108px] shrink-0">
                ...
                <div className="pointer-events-none absolute inset-0 flex flex-col items-center justify-center">
                  ...
                  >
                    {formatPercent(highPriorityPercent)}
                  </span>
                  <span
              ...
              <div className="min-w-0 flex-1">
                ...
                >
                  {highPriorityCount} of {total} villages are High or Very High
                </p>
                <div
                ...
                >
                  Urgent groundwater potential assessment needed
                </div>
              </div>
            </div>
          </div>
          ...
          >
            ...
            >
             Village Wise Class Distribution
            </p>
