...
const MainContent = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <main className="flex flex-col lg:flex-row gap-6 h-[calc(100vh-80px)] p-4">
        {/* LEFT SIDE — scrollable */}
        <div className="w-full lg:w-1/2 overflow-y-auto pr-3 space-y-4 bg-white rounded-xl shadow-md">
          <section className="rounded-xl overflow-hidden">
            <div className="border-b border-gray-200 bg-gray-50 px-6 py-4 sticky top-0 z-10">
                  ...
                  <div className="mb-8 bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    <div className="flex items-center justify-between mb-5">
                      <div className="flex-1">
                        <h2 className="text-lg font-semibold text-gray-800">Input Method</h2>
        ...
        <div className="w-full lg:w-1/2 overflow-y-auto pl-3 space-y-4 bg-white rounded-xl shadow-md">
