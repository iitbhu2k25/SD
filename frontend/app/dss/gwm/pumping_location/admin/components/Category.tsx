      ...
      <div className="bg-white rounded-lg shadow mb-6">
        ...
        <div className="flex border-b border-gray-200">
          <button
            ...
            className={`flex-1 py-3 px-4 text-center font-medium ${activeTab === 'condition'
          ...
          <button
            ...
            className={`flex-1 py-3 px-4 text-center font-medium ${activeTab === 'constraint'
              ? 'text-blue-600 border-b-2 border-blue-500'
              : 'text-gray-500 hover:text-gray-700'
              }`}
          >
                ...
                {firstHalf.map(category => (
                  <div key={category.id} className="flex items-start">
                    ...
                    <label
                      ...
                      className={`ml-2 block rounded-md p-2 cursor-pointer hover:bg-gray-50 ${isSelected(category.id) ? 'bg-gray-50' : ''
                        }`}
                    >
