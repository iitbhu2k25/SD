...
import { Village_columns } from "../../config/villageTableColumns";
import { downloadMarCsv } from "../../utils/downloadMarCsv";
      ...
      <div className="flex h-full flex-col">
        <header className={`flex shrink-0 items-center justify-between border-b px-3 ${
          ...
          <div className="flex shrink-0 items-center justify-self-end gap-1.5 sm:gap-2">
            <button
              onClick={() => downloadMarCsv(tableData, "MAR_Suitability_Drain.csv")}
