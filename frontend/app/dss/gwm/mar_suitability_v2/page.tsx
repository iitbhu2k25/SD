...
import { marSuitabilityPanelSettings } from "./config/panels.config";
...
export default function MarSuitabilityV2Page() {
  const panelSettings = marSuitabilityPanelSettings;
  ...
  useEffect(() => {
    ...
    const handleChange = (e: MediaQueryListEvent) => {
      ...
      setBottomPanelHeight(
        e.matches ? panelSettings.bottom.heightOpen : panelSettings.bottom.mobileHeightOpen
      );
    };
    ...
    selectedMode === "admin"
      ? adminCanShowRightPanel ? (
          <AdminRightPanel
            ...
            marProcess={adminViewModel.marProcess}
      ...
      : userCanShowRightPanel ? (
          <UserRightPanel
            ...
            marProcess={userViewModel.marProcess}
  ...
  const pageLayout = (
    <>
      ...
      <ModuleInfoModal
        ...
        imageAlt="MAR Suitability Information"
        points={[
          "Identifies suitable sites for Managed Aquifer Recharge (MAR) through logical queries based on multiple constraints and conditions affecting suitability of MAR implementation.",
          "Generates raster visual display of MAR suitability ranking across selected regions.",
          "Allows specific subsurface data querying by clicking on the map.",
        ]}
        learnMoreHref="/dss/home/home_grid/home_card/basic_module"
        learnMoreLabel="Learn more about MAR Suitability"
      />
    </>
  );
