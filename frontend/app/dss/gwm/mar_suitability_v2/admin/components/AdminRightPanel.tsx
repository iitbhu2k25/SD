...
export default function AdminRightPanel({
  ...
  const subsurfaceValidation = useAdminMapStore((state) => state.subsurfaceValidation);
  ...
  return (
    <>
      ...
      <div
        ref={containerRef}
        className={`absolute inset-y-0 right-0 z-30 max-w-full shrink-0 overflow-hidden border-l text-slate-800 shadow-2xl transition-[width] duration-300 ease-in-out lg:relative lg:inset-auto lg:z-auto ${
          isDark
