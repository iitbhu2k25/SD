...
import { useMap } from "@/contexts/stp_sutability/users/DrainMapContext";
import { useCategory } from "@/contexts/stp_sutability/admin/CategoryContext";
import "ol/ol.css";
import { useRiverSystem } from "@/contexts/stp_sutability/users/DrainContext";
...
const Maping: React.FC = () => {
  ...
  const createRiverSystemLayer = (
    ...
    const handleFeaturesError = (err: any): void => {
      console.log(`Error loading ${layerName} features:`, err);
      setLoading(false);
      updateLoadingState();
    };
