...
const OpenLayersRasterViewer: React.FC = () => {
  ...
  // Filter rasters
  const filteredRasters = Displaydata.reduce((acc: (RasterLayer & { module: string })[], module) => {
    if (selectedModule && module.module !== selectedModule) return acc;

    const filtered = module.raster.filter(raster =>
    ...
    return [...acc, ...filtered.map(raster => ({ ...raster, module: module.module }))];
  }, []);
  ...
  return (
    <div className="relative w-full h-screen bg-slate-900 flex flex-col md:flex-row">
      ...
      <div className="flex-1 relative p-1">
        ...
        {/* Map Coordinates */}
        <div className="absolute right-4 bottom-4 z-10 bg-slate-800/90 backdrop-blur-md p-3 rounded-lg border border-slate-600 shadow-xl">
          <div className="flex items-center space-x-2">
            <svg className="w-4 h-4 text-blue-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z" />
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M15 11a3 3 0 11-6 0 3 3 0 016 0z" />
            </svg>
            <div className="text-xs font-mono text-slate-200" id="mouse-position">
        ...
        {showLegend && legendUrl && (
          <div className="absolute bottom-20 right-4 z-10 bg-slate-900/95 backdrop-blur-md p-3 rounded-xl border border-slate-700 shadow-lg w-60">
        ...
        {/* Error Message */}
        {error && (
          <div className="absolute top-4 left-4 z-20 bg-red-900/90 backdrop-blur-md border border-red-600 text-red-200 px-4 py-3 rounded-lg shadow-xl flex items-center max-w-md w-full">
