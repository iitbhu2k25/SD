...
const Mapping: React.FC = () => {
  ...
  const handleVectorLayer = (layer: string | null, type: 'primary' | 'secondary' | 'result') => {
    ...
    const wfsUrl = `/geoserver/api/wfs?service=WFS&version=1.1.0&request=GetFeature&typeName=${defaultWorkspace}:${layer}&outputFormat=application/json&srsname=EPSG:3857${type === 'secondary' && LayerFilterValue && LayerFilter
