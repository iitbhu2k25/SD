...
const MapView = dynamic(
  () => import("@/app/dss/rwm/resource_estimation/water/users/components/openlayer"),
  {
    ssr: false,
    loading: () => (
...
import { RiverSystemProvider } from '@/contexts/water/users/DrainContext';
import { MapProvider } from '@/contexts/water/users/DrainMapContext';
import RiverSelector from '@/app/dss/rwm/resource_estimation/water/users/components/locations';
import WholeLoading from '@/components/app_layout/newLoading';
import { useRiverSystem } from '@/contexts/water/users/DrainContext';
// import MapView from '@/app/dss/rwm/resource_estimation/water/users/components/openlayer';
import { useMap } from '@/contexts/water/users/DrainMapContext';
import { toast } from 'react-toastify';
import 'react-toastify/dist/ReactToastify.css';
