...
export default function VarunaGallery() {
  ...
  const STATIC_IMAGE_MANIFEST: { [key: string]: string[] } = {
    ...
    'activities': ['Mr_Dheeraj_Joshi_Director_NMCG.png','Mr_Dheeraj_Joshi_Director_NMCG_.png','ISRO_MEMBERS.png'],
    'biodiversity': [
        'aquatic_plants.jpg',
        'Asian_openbill.jpg',
        ...
        'Hydrophytes.jpg',
        'Indian_Jujube.jpg',
        'Indian_pond_heron.jpg',
        'Indian_Roller.jpg',
        'klip_daga.jpg',
        'laughing_dove.jpg',
        'Marsilea_(clover).jpg',
        'Metallic_shield_bug.jpg',
        'Mollusca.jpg',
        'Myna.jpg',
        'Nilgai.jpg',
        'Oriental_magpie_Robin.jpg',
        'Peacock.jpg',
        'Peahens.jpg',
        'plain_tiger.jpg',
        'pond.jpg',
        'Red_wattled_lapwing.jpg',
        'riparian_vegetation.jpg',
        'Sarus_Crane.jpg',
        'toothache.jpg',
        'water_hen.jpg',
        'water_strider.jpg',
