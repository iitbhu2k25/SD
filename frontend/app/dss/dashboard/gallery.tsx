...
export default function VarunaGallery() {
  ...
  const STATIC_IMAGE_MANIFEST: { [key: string]: string[] } = {
    ...
    'conferences': ['RHAR_conference_2025.jpg','RHAR_conference_2025_.jpg','RHAR_2025.jpg','WORKSHOP_ON_NATURE_BASED_SOLUTION_FOR_SMALL_RIVER_REJUVENATION.png',
      'DSS_WORKSHOP.jpg','DSS__WORKSHOP.jpg','DSS_WORKSHOP_.jpg','DSS_WORKSHOP__.jpg'],
    'activities': ['Mr_Dheeraj_Joshi_Director_NMCG.jpeg','Mr_Dheeraj_Joshi_Director_NMCG_.jpeg','ISRO_MEMBERS.png'],
    'biodiversity': [
        'aquatic_plants.jpeg',
        'Asian_openbill.jpeg',
        'Asian_water_snake.jpg',
        'bamboo.jpeg',
        'banyan.jpeg',
        'Bat.jpeg',
        'beetle.jpeg',
        ...
        'Hydrophytes.jpeg',
        'Indian_Jujube.jpeg',
        'Indian_pond_heron.jpeg',
        'Indian_Roller.jpg',
        'klip_daga.jpeg',
        'laughing_dove.jpeg',
        'Marsilea_clover.jpeg',
        'Metallic_shield_bug.jpeg',
        'Mollusca.jpeg',
        'Myna.jpg',
        'Nilgai.jpg',
        'Oriental_magpie_Robin.jpeg',
        'Peacock.jpeg',
        'Peahens.jpeg',
        'plain_tiger.jpeg',
        'pond.jpeg',
        'Red_wattled_lapwing.jpeg',
        'riparian_vegetation.jpeg',
        'Sarus_Crane.jpg',
        'toothache.jpeg',
        'water_hen.jpeg',
        'water_strider.jpeg',
        'Lady_bug_beetle.jpeg',
        'water_birdnest.jpg'
    ],
    'outreach': ['NMCG_Review_Meeting.jpeg', 'NMCG_Review_Meeting_.jpeg']
  };
