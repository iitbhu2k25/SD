...
from .views import SendOTPView, VerifyOTPView, ResetPasswordView, EmployeeLeaveSummaryView
urlpatterns = [
    ...
    path('leavebalance', EmployeeLeaveSummaryView.as_view(), name='leave_balance'),
]
